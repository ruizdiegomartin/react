    ...
    <div className="cart-products-wrapper">
      ...
      {!cart.length ? (
        <div className="empty-cart-wrapper">
          <p className="empty-advise"> Bag is empty </p>{" "}
          <Link to="/">
            ...
            <div key={product.id} className="cart-product-container">
              ...
              <div className="info-container">
                ...
                <div className="info-group">
                  <p className="info-group__title"> Quantity: </p>
                  <p className="info-group__value info-variety">
                    {product.amount}{" "}
                  </p>
                </div>
                <div className="info-group">
                  <p className="info-group__title"> Price: $</p>
        ...
        <>
          <div className="cart-summary">
            ...
            <div className="total-price-group">
              ...
              <p className="total-price__amount">${totalPrice}</p>
            </div>
          </div>
          <div className="checkout-btn-div">
            ...
            <Link to="/checkout">
              <button className="add-to-cart-btn checkout-btn">
                {" "}
