...
export default function Checkout() {
  ...
  const carritoTest = cart.map((item) => {
    return {
      id: item.id,
      title: item.name,
  ...
  function validateName(name) {
    let reg =
      /^([a-zA-Z]{2,})\s([a-zA-Z]{2,})\s?([a-zA-Z]{2,})?\s?([a-zA-Z]{2,})?\s?([a-zA-Z]{2,})?\s?([a-zA-Z]{2,})?$/;
  ...
  function validateInputs() {
    if (
      ...
      validateConfirmEmail(mail) === false ||
      confirmEmail !== mail ||
    ...
    <div className="checkout-form-wrapper">
      {payConfirmed ? (
        <div className="confirmed-purchase-div">
          <p>
            The order has been processed correctly. <CheckCircleIcon />{" "}
          </p>
          <p>
            Your purchase identifier number is:{" "}
            ...
            >
              <div className="form-group">
                ...
                <div
                  className={
                    validateName(name)
                      ? "check-validated-circle"
                      : "check-invalid-circle"
                  }
                >
                  <CheckCircleIcon />
                </div>
              ...
              <div className="form-group">
                ...
                <input
                  type="text"
                  className={
                    validateConfirmEmail(confirmEmail) && mail === confirmEmail
                      ? "form-group__input-valid"
                      : "form-group__input-invalid"
                  }
                  placeholder="example@example.com"
              ...
              <div className="form-group">
                ...
                <input
                  ...
                  placeholder="1122223333 / 41112222"
                  value={phone}
              ...
              {validateInputs() ? (
                ...
                <>
                  <button
                    type="submit"
                    className="confirm-order-btn-disabled"
                    onClick={() => {
                      showAdvise("Invalid fields detected.");
                    }}
                  >
                    {" "}
                    CONFIRM ORDER{" "}
            ...
            <div className="checkout-summary">
              ...
              <div className="summary-section__products-wrapper">
                {cart.map((product) => {
                  return (
                    <article
                      className="summary-section__product"
                      key={product.id}
                    >
                      <img
                        className="summary-section__img"
                        src={product.pictureURL}
                        alt={product.name}
                      />
                      <h3 className="summary-section__name">
                        {" "}
                        {product.name}{" "}
                      </h3>
                      <p className="summary-section__quantity">
                        {" "}
                        x{product.amount}{" "}
                      </p>
                    </article>
              ...
              <p className="checkout-summary-totalprice">
                {" "}
