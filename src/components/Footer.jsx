            ...
            <section className="section-info">
                ...
                <div className="footer-column">
                    ...
                    <form className="form-footer">
                        ...
                        <button type="submit" className="send-btn-footer">SEND<SendIcon fontSize="small"/></button>
                    </form>
                </div>
            </section>
            <hr/>
            <div className="section-copyright">
                <h4 className="copyrights-text"> Web Design by <span className="dev">diegodev</span></h4>
