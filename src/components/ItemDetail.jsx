...
export default function ItemDetail({product}) {
  ...
  return (
    <article className='product-wrapper'>
      {maxLimitReached 
      ? <div className='warning-wrapper'><div className='warning-message-container'><p>Maximum limit reached: you're trying to add more units than current stock.</p></div> </div> 
      : ""}
        <div className='section-img'>
          <img className='product-detail-img' src={product.pictureURL} alt={product.name} />
        </div>
